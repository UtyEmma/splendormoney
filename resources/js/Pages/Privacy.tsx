...
export default function Privacy() {
    return (
        <MainLayout title='Terms and Conditions'>
            ...
            <section className='container py-5 mt-5 col-md-8 mx-auto'>
                <p>1. <strong>Introduction</strong></p>
                <p>Welcome to <strong>www.splendormoneyschool.com</strong>.</p>
                <p><strong>www.splendormoneyschool.com</strong> (&ldquo;us&rdquo;, &ldquo;we&rdquo;, or &ldquo;our&rdquo;) operates <strong>splendormoneyschool.com</strong> (hereinafter referred to as <strong>&ldquo;Service&rdquo;</strong>).</p>
                <p>Our Privacy Policy governs your visit to <strong>splendormoneyschool.com</strong>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
                ...
                <p><strong>SERVICE</strong> means the <strong>splendormoneyschool.com</strong> website operated by <strong>www.splendormoneyschool.com.</strong></p>
                ...
                <p><strong>Mentors</strong> - These users are able to create and upload online courses as well as admit students into various batches for tutelage.</p>
                <p><strong>Students</strong> - These users are able to purchase courses and attend classes online. They also have the privilege of owning a unique referral link where they can refer users to purchase courses from splendormoneyschool.com.</p>
                ...
                <p>Phone number</p>
                <p>Address, Country, State, Province, ZIP/Postal code,</p>
                ...
                <p><strong>www.splendormoneyschool.com</strong> uses the collected data for various purposes:</p>
                ...
                <p>to fulfil any other purpose for which you provide it;</p>
                ...
                <p>to fulfil the purpose for which you provide it;</p>
                ...
                <p>If you have any questions about this Privacy Policy, please contact us by email: <strong>support@splendormoneyschool.com</strong>.</p>
            </section>
        </MainLayout>
    )
}
